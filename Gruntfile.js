...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      js: {
        src: files,
        dest: 'dist/esri-leaflet-about-src.js'
      },
      css: {
        options: {
          banner: '',
        ...
        src: [
          'src/esri-leaflet-about.css'
        ],
        dest: 'dist/esri-leaflet-about-src.css'
      }
    },
    ...
    uglify: {
      ...
      dist: {
        files: {
          'dist/esri-leaflet-about.js': files
        }
      }
    },
    ...
    cssmin: {
      main: {
        ...
        files: {
          'dist/esri-leaflet-about.css': [
            'dist/esri-leaflet-about-src.css'
          ]
        }
      }
    },
    ...
    s3: {
      ...
      dev: {
        upload: [
          {
            src: 'dist/*',
            dest: 'esri-leaflet-about/<%= pkg.version %>/'
          },
          {
            src: 'dist/img/*',
            dest: 'esri-leaflet-about/<%= pkg.version %>/img'
          }
        ]
      }
    },
